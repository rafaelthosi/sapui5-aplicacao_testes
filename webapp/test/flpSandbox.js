		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#rtaplicacaotestesproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rtaplicacaotestesproject1-display": {
								"semanticObject": "rtaplicacaotestesproject1",
								"action": "display",
								"description": "Uma aplicação para realizar testes de SAPUI5",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rt.aplicacaotestes.project1",
									"url": sap.ui.require.toUrl("rt/aplicacaotestes/project1")
								}
							}
						}
					}
